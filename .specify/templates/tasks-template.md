...
only for explicitly non-behavioral work (for example docs-only updates).
...
- [ ] T010 Define rollback approach for risky configuration, schema, or behavior changes
...
- [ ] T019 [US1] Add user-access control checks and secret boundary verification where applicable
...
- [ ] T026 [US2] Add observability and rollback notes for US2 risk points
...
```bash
# Launch all tests for User Story 1 together (when behavior changes are in scope):
